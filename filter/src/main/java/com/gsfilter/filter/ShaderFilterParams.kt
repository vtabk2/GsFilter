        ...
        fun from(
            ...
            return combineAdjustments(recipe.adjustments.scaledBy(intensity), adjustments).let { combined ->
                ShaderFilterParams(
                    ...
                    underEye = amount(recipe.underEye, PERCENT_MAX) * intensity,
                    teethWhitening = amount(recipe.teethWhitening, PERCENT_MAX) * intensity,
                    eyeShadow = amount(recipe.eyeShadow, PERCENT_MAX) * intensity,
                    eyeliner = amount(recipe.eyeliner, PERCENT_MAX) * intensity,
