...
enum class FilterEffect(
    ...
    Graphite(jsonName = "graphite", shaderValue = 10f),
    BlackWhiteSketch(jsonName = "black_white_sketch", shaderValue = 11f),
    SketchColorPencil(jsonName = "sketch_color_pencil", shaderValue = 12f);
