...
object FilterCatalog {
    ...
    val options: List<FilterOption> = listOf(
        ...
        FilterOption(
            id = "soft_day",
            categoryIds = setOf(NATURAL, PORTRAIT),
        ...
        FilterOption(
            id = "rose_skin",
            categoryIds = setOf(PORTRAIT, AESTHETIC),
            nameRes = R.string.gs_filter_rose_skin,
            recipe = FilterRecipe(
                redShift = 13,
                greenShift = 3,
                blueShift = -5,
        ...
        FilterOption(
            id = "studio_skin",
            categoryIds = setOf(PORTRAIT, FILM),
        ...
        FilterOption(
            id = "flash_soft",
            categoryIds = setOf(PORTRAIT, COOL),
        ...
        FilterOption(
            id = "clean_face",
            categoryIds = setOf(PORTRAIT, AESTHETIC),
            nameRes = R.string.gs_filter_clean_face,
            recipe = FilterRecipe(
                redShift = 6,
                greenShift = 4,
                blueShift = 0,
        ...
        FilterOption(
            id = "deep_teal",
            categoryIds = setOf(CINEMATIC, COOL),
        ...
        FilterOption(
            id = "sunlit_forest",
            categoryIds = setOf(LANDSCAPE, WARM),
