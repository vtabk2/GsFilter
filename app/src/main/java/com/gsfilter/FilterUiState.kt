...
data class FilterUiState(
    ...
    val catalog: FilterPack = AppFilterCatalog.pack,
    val selectedCategory: FilterCategory = AppFilterCatalog.pack.defaultCategory,
    val selectedFilter: FilterOption = AppFilterCatalog.pack.defaultFilter,
